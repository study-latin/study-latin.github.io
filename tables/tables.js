const tables = {
    ...
    "Comparative adjective endings (-us, -a, -um, -is, -is, -e, -er, -a, -um, or -er, -is, -e)":[
        ...
        ["Nom. p.", "iōrēs",   "iōra"],
        ["Gen. p.", "iōrum",   "iōrum"],
        ["Dat. p.", "iōribus", "iōribus"],
        ["Acc. p.", "iōrēs",   "iōra"],
        ["Abl. p.", "iōribus", "iōribus"]
    ],
    ...
    "Superlative adjective endings (-er, -a, -um or -er, -is, -e)":[
        ["",        "M.",      "F.",      "N."],
        ["Nom. s.", "rimus",   "rima",    "rimum"],
        ["Gen. s.", "rimī",    "rimae",   "rimī"],
        ["Dat. s.", "rimō",    "rimae",   "rimō"],
        ["Acc. s.", "rimum",   "rimam",   "rimum"],
        ["Abl. s.", "rimō",    "rimā",    "rimō"],
        ["Nom. p.", "rimī",    "rimae",   "rima"],
        ["Gen. p.", "rimōrum", "rimārum", "rimōrum"],
        ["Dat. p.", "rimīs",   "rimīs",   "rimīs"],
        ["Acc. p.", "rimōs",   "rimās",   "rima"],
        ["Abl. p.", "rimīs",   "rimīs",   "rimīs"]
    ],
    "Irregular superlative adjectives":[
        ["",           "M.",           "F.",            "N."],
        ["Good",       "optimus",       "optima",       "optimum"],
        ["Bad",        "pessimus",      "pessima",      "pessimum"],
        ["Great",      "maximus",       "maxima",       "maximum"],
        ["Small",      "minimus",       "minima",       "minimum"],
        ["Much",       "plurimus",      "plurima",      "plurimum"],
        ["Many",       "plūrimī",       "plūrimae",     "plūrima"],
        ["Easy",       "facillimus",    "facillima",    "facillimum"],
        ["Difficult",  "difficillimus", "difficillima", "difficillimum"],
        ["Similar",    "simillimus",    "simillima",    "simillimum"],
        ["Dissimilar", "dissimillimus", "dissimillima", "dissimillimum"],
